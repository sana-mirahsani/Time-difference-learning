...
# =============================================================================
class agent_class:
    def __init__(self, S, A, gamma, terminal_state_idx, EPISODE_BLOCK):
        """
        Initialize an agent.
    ...
    def Q_learning_func(self, obj_env, discount_value, initial_state_idx , select_action_strategy, Q_optimal=None, tolerance = 0.1, T=1000):
        """
        ...
        while True:
            ...
            for episode in range(self.EPISODE_BLOCK):
                ...
                while not done:
                    ...
                    done = self.stop_condition(obj_env.gamma, step, s_idx)
    ...
    def stop_condition(self, gamma, step, current_state_idx):
    ...
    def trainning(self, RL_method, action_strategy, Q_optimal_policy, env_obj, initial_state_idx, tolerance):

        if RL_method == "Q_Learning":
            Q_hat, epsilon_values, total_interaction = self.Q_learning_func(env_obj, self.gamma, initial_state_idx, action_strategy, Q_optimal_policy, tolerance)
            return Q_hat, epsilon_values, total_interaction
